...
export const metadata: Metadata = createPageMetadata({
  title: "Contact TGK | The Guardian's Keeper",
  description:
    "Contact TGK to donate, volunteer, partner, or learn more about how The Guardian's Keeper supports police welfare and safer communities in Nigeria.",
  path: "/contact",
  image:
    "https://res.cloudinary.com/df2e1ug1q/image/upload/v1774352998/WhatsApp_Image_2025-11-26_at_20.15.08_1_rrikko.jpg",
});
  ...
  return (
    <div className="overflow-x-hidden">
      <PageHero
        ...
        imgAlt="TGK volunteers connecting with officers during a community visit in Lagos"
      />
            ...
            <div>
              <ScrollReveal>
                ...
                <h2 className="text-5xl font-light text-[#0B1D35] leading-tight mb-8">
                  Let&apos;s Build a
                  <br />
                  <em className="text-[#BF8C3A]">Better Nigeria</em>
                </h2>
                <p className="text-[#8A96A3] text-base leading-9 mb-14">
                  TGK welcomes donors, volunteers, corporate partners, and
                  advocates. Every connection we make brings us closer to a
                  Nigeria where those who protect us are also protected.
                </p>
                <div className="mb-12">
                  <Link
                    href="/programs"
                  ...
                  >
                    Explore TGK programs before you reach out
                  </Link>
                </div>
              </ScrollReveal>
              ...
              <div className="flex flex-col gap-6 mb-14">
                {[
                  {
                    Icon: Mail,
                    val: "social.theguardians@gmail.com",
                    href: "mailto:social.theguardians@gmail.com",
                    label: "Email",
                  },
                  {
                    Icon: Phone,
                    val: "+234 707 357 9759",
                    href: "tel:+2347073579759",
                    label: "Phone",
                  },
                  {
                    Icon: Phone,
                    val: "+234 816 782 7920",
                    href: "tel:+2348167827920",
                    label: "Phone 2",
                  },
                  {
                    Icon: MapPin,
                  ...
                  <ScrollReveal key={label + i} delay={i * 0.1}>
                    <a href={href} className="flex items-center gap-5 group">
                      <div className="w-12 h-12 rounded-xl bg-[#F9F6EF] border border-[#0B1D35]/8 flex items-center justify-center group-hover:bg-[#BF8C3A] transition-colors flex-shrink-0">
                        <Icon
                          size={17}
                          className="text-[#BF8C3A] group-hover:text-white transition-colors"
                        />
                      </div>
                      <span className="text-[#0B1D35] text-sm group-hover:text-[#BF8C3A] transition-colors">
                        {val}
                      </span>
                    </a>
                  </ScrollReveal>
              ...
              <ScrollReveal>
                <p className="text-[#0B1D35] text-xs tracking-[0.25em] uppercase font-semibold mb-5">
                  Follow Us
                </p>
        ...
        <div className="max-w-6xl mx-auto px-8 md:px-16 lg:px-24">
          <ScrollReveal className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-light text-white">
              Ways to <em className="text-[#D4A855]">Support TGK</em>
            </h2>
          </ScrollReveal>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: "Donate",
                desc: "Every naira funds welfare, resources, and programs for officers and their families.",
              },
              {
                title: "Volunteer",
                desc: "Join our outreach teams and contribute your time and skills on the ground.",
              },
              {
                title: "Partner",
                desc: "Organisations and companies can amplify our impact through structured partnerships.",
              },
              {
                title: "Advocate",
                desc: "Spread the word, follow us, share our mission — change the national conversation.",
              },
            ].map((c, i) => (
              <ScrollReveal key={c.title} delay={i * 0.1}>
                <div className="lift border border-white/10 rounded-2xl p-8 bg-white/3 hover:bg-white/6 transition-colors h-full">
                  <p
                    className="text-[#BF8C3A] text-3xl font-light mb-5"
