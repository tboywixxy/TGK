...
const stats = [
  {
    ...
    suffix: "",
    label: "Raincoats Distributed",
    note: "To officers across 4 Lagos divisions",
  },
  {
    end: 97,
    suffix: "",
    label: "Officers Directly Reached",
    note: "Plus 5 given to TGK volunteers",
  },
  {
    end: 4,
    suffix: "",
    label: "Divisions Visited",
    note: "Police Training School, Ikeja, Maroko, VI",
  },
  {
    end: 5,
    suffix: "",
    label: "Volunteers Deployed",
    note: "Fully funded outreach team",
  },
  {
    end: 1223940,
    suffix: "",
    label: "Naira Spent (Total)",
    note: "Every kobo publicly accounted for",
    prefix: "₦",
  },
  {
    end: 250000,
    suffix: "+",
    label: "Officers We Aim to Reach",
    note: "The Nigerian Police Force nationwide",
  },
];
...
const locations = [
  {
    name: "Nigerian Police Training School",
    area: "Lagos State",
    img: "https://res.cloudinary.com/df2e1ug1q/image/upload/v1774353044/IMG-20251126-WA0054_1_atxu6w.jpg",
  },
  {
    name: "Ikeja Divisional Headquarters",
    area: "Ikeja, Lagos",
    img: "https://res.cloudinary.com/df2e1ug1q/image/upload/v1774353040/IMG-20251128-WA0003_lgfvrx.jpg",
  },
  {
    name: "Maroko Divisional Headquarters",
    area: "Maroko, Lagos",
    img: "https://res.cloudinary.com/df2e1ug1q/image/upload/v1774353039/IMG-20251128-WA0002_cjeysp.jpg",
  },
  {
    name: "Victoria Island Divisional HQ",
    area: "V/I, Lagos",
    img: "https://res.cloudinary.com/df2e1ug1q/image/upload/v1774353035/IMG-20251126-WA0050_u3c7yr.jpg",
  },
];

export const metadata: Metadata = createPageMetadata({
  title: "TGK Impact | Supporting Police and Safer Communities",
  description:
    "See TGK impact reports, outreach results, and transparent reporting on how The Guardian's Keeper supports police welfare and safer communities.",
  path: "/impact",
  image:
    "https://res.cloudinary.com/df2e1ug1q/image/upload/v1774353039/IMG-20251128-WA0001_w2zt6d.jpg",
});
  ...
  return (
    <div className="overflow-x-hidden">
      <PageHero
        ...
        imgAlt="TGK volunteers and police officers during the first TGK outreach impact visit in Lagos"
      />
        ...
        <div className="max-w-6xl mx-auto px-8 md:px-16 lg:px-24">
          <ScrollReveal className="mb-18 text-center">
            ...
            <h2 className="text-5xl font-light text-[#0B1D35]">
              First Outreach — <em className="text-[#BF8C3A]">Results</em>
            </h2>
          </ScrollReveal>
            ...
            {stats.map((s, i) => (
              <ScrollReveal key={s.label} delay={i * 0.08}>
                <div className="lift group border border-[#0B1D35]/8 rounded-2xl p-10 bg-[#F9F6EF] hover:bg-[#0B1D35] transition-colors duration-500 h-full text-center">
                  <p
                    className="text-5xl md:text-6xl font-light text-[#BF8C3A] group-hover:text-[#D4A855] transition-colors mb-4"
                  ...
                  <p className="text-[#0B1D35] group-hover:text-white font-semibold text-sm mb-2 transition-colors">
                    {s.label}
                  </p>
                  <p className="text-[#8A96A3] group-hover:text-white/45 text-xs transition-colors">
                    {s.note}
                  </p>
                </div>
              </ScrollReveal>
      ...
      <section className="py-28 bg-[#F9F6EF]">
        <div className="max-w-6xl mx-auto px-8 md:px-16 lg:px-24">
          <ScrollReveal className="mb-16">
            ...
            <h2 className="text-4xl font-light text-[#0B1D35]">
              Where We <em className="text-[#BF8C3A]">Went</em>
            </h2>
          </ScrollReveal>
            ...
            {locations.map((loc, i) => (
              <ScrollReveal key={loc.name} delay={i * 0.1}>
                <div className="lift group rounded-2xl overflow-hidden relative aspect-[3/4]">
                  <img
                    src={loc.img}
                    alt={`${loc.name} during TGK outreach support in ${loc.area}`}
        ...
        <div className="max-w-4xl mx-auto px-8 md:px-16 lg:px-24">
          <ScrollReveal className="mb-14">
            ...
            <h2 className="text-4xl font-light text-white">
              Expenditure <em className="text-[#D4A855]">Breakdown</em>
            </h2>
            <p className="text-white/40 text-sm mt-3">
              Every naira, publicly reported.
            </p>
          </ScrollReveal>
          <div className="flex flex-col gap-3">
            ...
            <ScrollReveal delay={0.5}>
              ...
              <p className="text-white/30 text-xs mt-4 italic pl-1">
                * Vehicle donated by Hope Okwa — no vehicle cost incurred save
                fueling.
              </p>
            </ScrollReveal>
          </div>
      ...
      <section className="py-28 bg-white">
        <div className="max-w-6xl mx-auto px-8 md:px-16 lg:px-24">
          <ScrollReveal className="mb-14 text-center">
            <span className="gold-bar mx-auto mb-6" />
            <h2 className="text-4xl font-light text-[#0B1D35]">
              The Volunteers Who <em className="text-[#BF8C3A]">Made It Happen</em>
            </h2>
          </ScrollReveal>
      ...
      <section className="py-28 bg-[#F9F6EF]">
        <div className="max-w-4xl mx-auto px-8 md:px-16 lg:px-24 text-center">
          <ScrollReveal>
            <span className="gold-bar mx-auto mb-6" />
            <h2 className="text-4xl font-light text-[#0B1D35] mb-6">
              Download Our <em className="text-[#BF8C3A]">Full Report</em>
            </h2>
            <p className="text-[#8A96A3] text-sm mb-10">
              Get the complete PDF report of our first outreach, including
              detailed breakdowns and photos.
            </p>
            <a
            ...
            <div className="mt-8">
              ...
              >
                View photos from this outreach
                <ArrowRight
                  size={15}
