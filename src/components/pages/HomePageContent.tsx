    ...
    () => [
      {
        ...
        alt: "TGK outreach team visiting the Nigerian Police Training School in Lagos",
      },
      {
        type: "video" as const,
      ...
      },
      {
        ...
        alt: "TGK volunteers distributing outreach materials to police officers in Lagos",
      },
      {
        type: "video" as const,
    ...
    <div className="overflow-x-hidden">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 text-center pt-20 pb-10 sm:pt-24 sm:pb-12">
          <div className="mb-4 sm:mb-5 flex justify-center">
            <img
              ...
              alt="The Guardian's Keeper logo"
      ...
      <section className="bg-[#BF8C3A] py-6">
        <div className="max-w-6xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white text-sm font-medium tracking-wide text-center md:text-left">
            Humanizing and supporting the Nigerian Police Force â€” one step at a
            time.
          </p>
          <Link
            href="/programs"
            ...
            <div className="max-w-2xl">
              ...
              <ScrollReveal delay={0.15}>
                <p className="text-[#8A96A3] text-base leading-8 sm:leading-9 mb-6">
                  ...
                  foundation focused on police welfare, mental health, dignity,
                  and public trust. We believe that a supported, humanized police
                  force is part of building safer communities.
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <ScrollReveal animation="reveal-left">
              <div className="relative rounded-3xl overflow-hidden aspect-[4/3]">
                <img
                  src="https://res.cloudinary.com/df2e1ug1q/image/upload/v1774352997/IMG-20251126-WA0000_nkt4jj.jpg"
                  alt="TGK volunteers during the first outreach to police divisions in Lagos"
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <p
                    ...
                    style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  >
                    First Outreach â€” November 2025
                  </p>
                  <p className="text-white/60 text-sm mt-1">
                    Lagos, Nigeria Â· 4 Divisions Visited
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <div className="max-w-2xl">
              <ScrollReveal animation="reveal-right">
                ...
                <p className="text-white/50 text-base leading-8 sm:leading-9 mb-10 sm:mb-12">
                  ...
                  divisions across Lagos, distributing 102 raincoats â€” a simple
      ...
      <section className="py-24 sm:py-28 bg-white">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 text-center">
          <ScrollReveal>
            <span className="gold-bar mx-auto mb-6" />
            <h2 className="text-4xl sm:text-5xl font-light text-[#0B1D35] mb-6">
        ...
        <div className="max-w-4xl mx-auto px-6 sm:px-8 md:px-12 lg:px-16 text-center">
          <ScrollReveal>
            ...
            <p className="text-[#8A96A3] text-base leading-8 sm:leading-9 max-w-2xl mx-auto mb-12 sm:mb-14">
              ...
              to protecting Nigeria. Every act of support â€” no matter how small
              â€” creates ripples that transform communities.
            </p>
