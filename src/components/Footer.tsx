      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 pt-20 pb-10">
        <div className="grid md:grid-cols-12 gap-12 pb-14 border-b border-white/10">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center gap-3 mb-6">
              <div className="relative w-22 h-22  overflow-hidden flex items-center justify-center">
                <Image
              ...
              <div>
                ...
                <p className="text-[#D4A855] text-[10px] tracking-[0.3em] uppercase">
                  Nigeria
                </p>
              </div>
            </div>
            ...
            <p className="text-white/45 text-sm leading-7 max-w-xs">
              A registered Nigerian foundation dedicated to supporting and
              humanizing the Nigerian Police Force — because even protectors
              need help.
            </p>
          ...
          <div className="md:col-span-3">
            <p className="text-white text-xs tracking-[0.25em] uppercase font-semibold mb-6">
              Navigate
            </p>
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-white/45 hover:text-[#D4A855] text-sm transition-colors"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex flex-col gap-4">
              <a
                ...
                className="flex items-start gap-3 text-white/45 hover:text-white text-sm transition-colors"
              >
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-white/25 text-xs text-center md:text-left">
            &copy; {new Date().getFullYear()} The Guardian Keepers Foundation for
            Public Welfare and Care. All rights reserved.
          </p>
